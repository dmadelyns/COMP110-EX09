...
1. Idea to analyze with available data: The course's workload should better consider student's prior experience because students with less experience spend more time on coursework and may stuggle to keep up. 

2. This idea is more valuable than the others brainstormed because: This idea is more valuable because data was collected about the students' prior expereience and the amount of time tgey spend on coursework. I was able to create a graph that directly demostrates tge relationship between students prior experience and time spend on coursework. We do have to account for others factors that may skew these results. 
